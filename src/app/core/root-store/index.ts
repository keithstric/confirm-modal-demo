...
import {
  ...
  iUserState,
  RouterStateUrl
} from '../root-store/models/app-state.model';

import * as fromRouter from '@ngrx/router-store';
import * as fromUser from '../root-store/user';
import * as fromLoading from '../root-store/loading';
import {
  ActionReducerMap,
...
export const selectLoadingFeatureState = createFeatureSelector<boolean>(
  'loading'
);
